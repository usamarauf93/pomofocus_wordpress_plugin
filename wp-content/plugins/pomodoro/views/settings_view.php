   ...
   <div class="sc-cmTdod time-mins-section">
         ...
         <div class="switch-task">
            <div class="sc-cmTdod time-mins-section">
               ...
               <div class="sc-dfVpRl progress-bar-alignment">
                  <div class="sc-gxMtzJ ikhjgi">
                     <div class="sc-iyvyFf gaWFYr">50</div>
                     <input type="range" min="0" max="100" class="slider sc-gzOgki progress-bar-control" id="myRange" value="50">
                  </div>
               </div>
               <div class="sc-kIPQKe repeat-counter">repeat<input type="number" min="1" step="1" class="sc-jhAzac sc-eXEjpC counter-input-field repeat-input-field" value="1"></div>
            </div>
            <div class="sc-cmTdod time-mins-section">
               <div class="sc-kPVwWT wrapper-spacing">
               ...
               <div class="sc-dfVpRl progress-bar-alignment">
                  <div class="sc-gxMtzJ ikhjgi">
                     <div class="sc-iyvyFf gaWFYr">51</div>
                     <input type="range" min="0" max="100" class="slider sc-gzOgki progress-bar-control" id="myRange" value="51">
                  </div>
               </div>
            </div>
         </div>
         <div class="sc-hrWEMg iKJgBK"></div>
         <div class="sc-eTuwsz sections-heading-bar"><i class="fa-solid fa-wand-magic-sparkles"></i>Theme</div>
         <div class="sc-bwCtUz cpucXQ">
            <div class="sc-cmTdod time-mins-section">
               <div class="sc-kPVwWT wrapper-spacing">
                  <div class="sc-jwKygS top-headingz"><span class="sc-btzYZH heading-aligned-spacing">Color Themes</span></div>
                  <div class="sc-ibxdXY colors-parent-div">
                     <div color="rgb(186, 73, 73)" class="sc-RefOD color-child1"></div>
                     <div color="rgb(56 133 138)" class="sc-RefOD color-child2"></div>
                     <div color="rgb(57 112 151)" class="sc-RefOD color-child3"></div>
                  </div>
               </div>
            </div>
            <div class="sc-cmTdod time-mins-section">
               <div class="sc-kPVwWT wrapper-spacing">
                  <div class="sc-jwKygS top-headingz"><span class="sc-btzYZH heading-aligned-spacing">Hour Format</span></div>
                  <div class="sc-esjQYD dropdown-item-select">
                     <div width="130" font-size="14" class="sc-kjoXOD dropdown-item-select-inner">
                        <div class="sc-ksYbfQ cKvWkx">
                           <select class="sc-kgAjT goKNLl">
                              <option class="sc-cJSrbW bGbrbr">24-hour</option>
                              <option class="sc-cJSrbW bGbrbr">12-hour</option>
                           </select>
                        </div>
                     </div>
                  </div>
            ...
            <div class="sc-cmTdod time-mins-section">
               <div class="sc-kPVwWT wrapper-spacing">
                  ...
                  <button class="sc-bxivhb sc-gqjmRU hhrgqO">Open <i class="fa-solid fa-up-right-from-square"></i></button>
               </div>
            </div>
         </div>
         <div class="sc-hrWEMg iKJgBK"></div>
         <div class="sc-eTuwsz sections-heading-bar"><i class="fa-solid fa-bell"></i>Notification</div>
         <div class="sc-bwCtUz cpucXQ">
            <div class="sc-cmTdod time-mins-section">
               <div class="sc-kPVwWT wrapper-spacing">
            ...
            <div class="sc-cmTdod time-mins-section">
               <div class="sc-kPVwWT wrapper-spacing">
                  ...
                  <div class="sc-esjQYD dropdown-item-select"><button class="sc-bxivhb sc-jTzLTM sc-hZSUBg eUSqvS">+ Add this device</button></div>
               </div>
            </div>
         </div>
      </div>
